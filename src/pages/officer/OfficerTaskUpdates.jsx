...
export default function OfficerTaskUpdates() {
  const { tasks, officer } = useOfficer();

  // Build a flat, time-ordered feed from static timeline entries and
  // any dynamic updates the officer has posted.
  const feed = useMemo(() => {
    const items = [];
    tasks.forEach((t) => {
